...
public class TestCompositeWithAlpha {
    ...
    private static void drawDst(JEasyGraphics eg, int x, int y) {
        ...
        eg.setFillColor(new Color(0x800000ff,true));
        eg.fillRectangle(x,y,x+60,y+60);
        eg.setFillColor(new Color(0x80FFCE43,true));
        eg.fillRectangle(x+10,y+10,x+50,y+50);
    }

    private static void drawSrc(JEasyGraphics eg,int x, int y) {
        eg.setFillColor(new Color(0x80ff0000,true));
        eg.fillRectangle(x,y,x+60,y+60);
        eg.setFillColor(new Color(0x8026AAD1,true));
